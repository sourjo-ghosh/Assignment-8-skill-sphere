...
import { ArrowRight, CircleCheck, CircleExclamation, Eye, Square, SquareCheck } from '@gravity-ui/icons';
import { FiEyeOff } from 'react-icons/fi';
import { BiLoader } from 'react-icons/bi';
// import { Eye, EyeOff, CircleCheck, CircleExclamation, Loader } from '@gravity-ui/icons';
        ...
        <form className="mt-8" onSubmit={onSubmit}>
          ...
          <div className="mt-3 flex flex-col justify-start gap-1">
            ...
            <div className="text-black text-[15px]">
                ...
                >
                  {showPassword ? <div className="flex justify-center items-center gap-2"><SquareCheck/> Hide Password</div> : <div className="flex justify-center items-center gap-2"><Square/> Show Password</div> }
                </button>
            </div>
          ...
          <p className="mt-4 text-[16px] text-[#434655]">Already have an account?
